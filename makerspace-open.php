...
Author URI: http://www.terminalpixel.co.uk
*/
    ...
    class MakerspaceOpen {
        ...
        public static function get_members( $force_all = false ) {
            ...
            foreach ( $users as $user ) {
                ...
                if ( ( $membership && $membership->id == static::$membership_level_id ) && ( !$hide_member || $force_all == true ) ) {
                    $member = new StdClass();
